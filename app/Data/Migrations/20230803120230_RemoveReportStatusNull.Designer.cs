...
namespace Monitor.Data.Migrations
{
    ...
    [Migration("20230803120230_RemoveReportStatusNull")]
    partial class RemoveReportStatusNull
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Monitor.Data.Entities.Identity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Monitor.Data.Entities.RegistrationAllowlistEntry", b =>
                {
            ...
            modelBuilder.Entity("Monitor.Data.Entities.RegistrationRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Monitor.Data.Entities.Team", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Monitor.Data.Entities.Identity.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Monitor.Data.Entities.Identity.ApplicationUser", b =>
                {
                    b.HasOne("Monitor.Data.Entities.Team", "Team")
                        .WithMany("Members")

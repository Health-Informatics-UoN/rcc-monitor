...
export default async function Reports() {
  ...
  const siteConflictsReports = reports.filter((v) => v.reportType.name == "ConflictingSite");
  const siteNameConflictsReports = reports.filter((v) => v.reportType.name == "ConflictingSiteName");
  const siteParentConflictsReports = reports.filter((v) => v.reportType.name == "ConflictingSiteParent");
  ...
  const siteParentConflictsReportsRow = siteParentConflictsReports.map((row) => {
  ...
  const reportsObj = {
    ...
    siteNameConflicts: {
      ...
      report: {
        columns: ["Time Occured", "Status", "Site Id", "Site Name - Build", "Site Name - Production", "Site Name - UAT" ],
    ...
    siteConflictsParents: {
      ...
      report: {
        columns: [ "Time Occured", "Status", "Parent Site Id - Build", "Parent Site Id - Production", "Parent Site Id - UAT", "Site Name" ],
  ...
  return (
    <>
      ...
      <Tabs defaultValue="Site Conflicts" w="95%" position="relative" m="30px auto">
        <TabsList
          w="full"
